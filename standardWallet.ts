 ...
 *
 */
export class OktoWalletAccount implements AptosWalletAccount {
...
export class OktoWallet implements AptosWallet {
  readonly url: string = "https://aptos.dev";
  // This should be updated whenever you release a new implementation of "OktoWallet"
  readonly version = "1.0.0";
  readonly name: string = "Okto Wallet";
  /**
   ...
   */
  accounts: OktoWalletAccount[] = [];

  // Local OktoWallet class variables,
  /**
  ...
  constructor() {
    ...
    this.accounts = [new OktoWalletAccount(this.signer)];
  }
